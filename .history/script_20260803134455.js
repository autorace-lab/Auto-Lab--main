...
recentRaces: recentRaces
    ...
    const infoRows =
doc.querySelectorAll(".race-infoTable tbody tr");
...
const cells =
infoRows[1].querySelectorAll("td");

weather = cells[3]?.innerText || "";
trackTemp = cells[2]?.innerText || "";
track = cells[3]?.innerText || "";
