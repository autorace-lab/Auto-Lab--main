...
const cells =
infoTables[1].querySelectorAll("td");

console.log("td数", cells.length);
...
console.log("気象td数", cells.length);

cells.forEach((cell,index)=>{
console.log("気象HTML", index, cell.innerHTML);
});

weather = infoTables[0]
.querySelectorAll("tbody td")[3]
.textContent.trim();
